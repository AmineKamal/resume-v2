        ...
        <section id="about" className="s-about target-section">
            ...
            <div className="row block-large-1-2 block-900-full work-positions">
                ...
                <div className="position">
                    ...
                    <div className="position__timeframe">August 2015 - June 2017</div>
                    </div>
                    <p>
                ...
                <div className="position">
                    ...
                    <p>
                    In hac habitasse platea dictumst. Donec pede justo, fringilla vel,
                    aliquet nec, vulputate eget, arcu. Fusce risus nisl, viverra et,
                    tempor et, pretium in, sapien. Phasellus volutpat, metus eget.
                    </p>
                </div>
                </div>
                <div className="column" data-aos="fade-up">
                <div className="position">
                    ...
                    arcu. Curabitur blandit mollis lacus. Curabitur vestibulum aliquam
                    leo. Vivamus in erat ut urna cursus vestibulum.
                    </p>
                </div>
                </div>
            </div>
