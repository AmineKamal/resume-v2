    ...
    return (
        <section id="services" className="s-services target-section h-dark-bg">
            ...
            <div className="column large-6 s-services__leftcol">
                ...
                Suspendisse eu ligula. Duis arcu tortor, suscipit eget, imperdiet nec,
                imperdiet iaculis, ipsum. Nulla facilisi. Etiam rhoncus. Praesent
                blandit laoreet nibh. Donec quam felis, ultricies nec, pellentesque
                eu, pretium quis, sem. Cras sagittis. Praesent egestas tristique nibh.
                </p>
            </div>
            <div className="column large-6">
                ...
                <li className="services-list__item is-active">
                    ...
                    <p>
                        ...
                        pede sit amet augue. Praesent blandit laoreet nibh. Donec quam
                ...
                <li className="services-list__item">
                    ...
                    <p>
                        ...
                        velit leo quis pede. In consectetuer turpis ut velit. Curabitur
                        at lacus.
                    </p>
                    </div>
                </li>
                <li className="services-list__item">
                    ...
                    <p>
                        ...
                        turpis. Nunc egestas, augue at pellentesque laoreet, felis eros
                ...
                <li className="services-list__item">
                    ...
                    <div className="services-list__item-body">
                    <p>
                        Nullam quis ante. Sed libero. Curabitur at lacus ac velit ornare
                        lobortis. Morbi nec metus. Aenean vulputate eleifend tellus.
                        Nullam vel sem. Nam ipsum risus, rutrum vitae, vestibulum eu,
                        molestie vel, lacus. Phasellus ullamcorper ipsum rutrum nunc.
                ...
                <li className="services-list__item">
                    ...
                    <p>
                        ...
                        egestas mollis, lacus lacus blandit dui, id egestas quam mauris
                        ut lacus. Cras dapibus. Praesent adipiscing.
                    </p>
                    </div>
                </li>
                <li className="services-list__item">
